...
class Highway(nn.Module):
    ...
    def forward(self, X_conv_out: torch.Tensor) -> torch.Tensor:
        """
            ...
            @param X_conv_out: Tensor with shape (max_sentence_length, batch_size, embed_size)
            @return X_highway: combinded output with shape (max_sentence_length, batch_size, embed_size)
        """
